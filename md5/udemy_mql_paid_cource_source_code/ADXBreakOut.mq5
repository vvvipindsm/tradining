...
void Buy()
  {
   if(RangeEnding())
     {
      Trade.BuyStop(LotSize,BuyEntryPrice,_Symbol,BuySLPrice,BuyTP(),ORDER_TIME_GTC,0,"Buy Stop");
      bought = true;
     }
  }
...
void Sell()
  {
   if(RangeEnding())
     {
      Trade.SellStop(LotSize,SellEntryPrice,_Symbol,SellSLPrice,SellTP(),ORDER_TIME_GTC,0,"Sell Stop");
      sold = true;
     }
  }
//+------------------------------------------------------------------+
