...
sinput string MARTINGALEINPUTS = ""; //=== MARTINGALE INPUTS ===
input ENUM_MARTINGALE LotToUse = SemiMartingale;
input double MartingaleMultiplier = 2;
input double LotChange = 0.02;
input int MartingaleLimit = 4;
...
double STP,SellSLPrice,BuySLPrice,BuyEntryPrice,SellEntryPrice,Lots;
...
void OnTick()
  {
   ...
   Lots = MartingaleLot(_Symbol,LotSize,EAMagic,SemiMartingale,MartingaleMultiplier,MartingaleLimit,LotChange);
